    ...
    Lua::getGlobalNamespace(lua.GetState())
        .beginNamespace("Graphics")
            .beginClass<ScreenSpace>("ScreenSpace")
                ...
                .addFunction("SetTargetSize", &ScreenSpace::SetTargetSize)
                .addFunction("GetTargetSize", &ScreenSpace::GetTargetSize)
                ...
                .addFunction("GetTransform", &ScreenSpace::GetTransform)
            .endClass()
        .endNamespace();
